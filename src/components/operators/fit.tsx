...
const FITS = [
  "You run 8+ locations or a growing franchise.",
  "You're tired of fees that scale with your growth.",
  "You want to own your member relationship and data.",
  "You plan to add sites in the next 18 months.",
];

const NOT_FITS = [
  "You have fewer than 8 sites. The payback is usually too long, and I'll tell you so.",
  "You want the cheapest possible monthly subscription.",
  "You're not ready to own and maintain your own platform.",
