...
export const alt = "Gimmir — Product engineering for sport & fitness";
...
/** The site-wide social share card, statically generated at build time. */
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* lime glow, echoing the site's CTA panels */}
        <div
          style={{
            position: "absolute",
            right: -140,
        ...
        >
          <div style={{ display: "flex", fontSize: 30, color: "rgba(246,244,238,0.75)" }}>
            Built by founders who have shipped real fitness platforms
          </div>
